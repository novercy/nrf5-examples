...
void uarte0_uart0_isr(void){
  ...
  if(uarte_received_endrx(UARTE0)){
    gpio_toggle(GPIO17);
    uarte_send_waiting(UARTE0, uarte_rx_received_ptr(UARTE0), uarte_rx_received_maxcnt(UARTE0));
    //UARTE0_TXD.PTR = UARTE0_RXD.PTR;
    //UARTE0_TXD.MAXCNT = UARTE0_RXD.MAXCNT;
